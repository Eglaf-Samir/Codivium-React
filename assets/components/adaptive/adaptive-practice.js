(() => {
  ...
  function buildRingSvg(pct, state) {
    ...
    track.setAttribute('fill', 'none'); track.setAttribute('stroke', trackColor); track.setAttribute('stroke-width', '3.5');
    ...
    if (pct > 0) {
      ...
      arc.setAttribute('fill', 'none'); arc.setAttribute('stroke', fillColor); arc.setAttribute('stroke-width', '3.5');
