// src/shared/HelpPanel.jsx
// Help & Support panel + attempt-first modal — shared across all React bundles.
//
// Responsibilities:
...
import { resolve } from './routeConfig.js';
import React, {
    ...
    <>
      ...
      >
        ...
        <div className="cvh-body">
          ...
          <a className="cvh-link" href={resolve('faq')}
