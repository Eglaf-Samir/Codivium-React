export const allpackages = 'api/v1/package/allpackage';
...
//admin
export const getepackagebyid = 'api/v1/package/';
export const createpackage = 'api/v1/package';
export const getallepackage = 'api/v1/package/allpackage';
export const updatepackage = 'api/v1/package';
export const deletepackage = 'api/v1/package/packageDelete?id=';

export const getallCurrency = 'api/v1/paramMaster/GetDropdown?keyvalue=';
