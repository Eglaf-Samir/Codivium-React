...
import { getCategoryPath, STATUS_ICON_PATHS, STATUS_CLASS, STATUS_LABEL } from '../assets/icons/categoryIcons';
...
export default function ExerciseCard({ exercise: ex, returnUrl }) {
  ...
  const href        = `editor.html?id=${encodeURIComponent(ex.id)}&from=${encodeURIComponent(returnUrl)}`;
