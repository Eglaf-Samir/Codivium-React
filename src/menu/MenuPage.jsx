// MenuPage.jsx — Root component for the exercise menu page.
...
import HelpPanel    from '../editor/components/HelpPanel.jsx';
...
export default function MenuPage() {
  ...
  // demo data always has track:'micro' which would incorrectly make isMicro=true
  // on the interview page (?track=interview) before/if real data loads.
