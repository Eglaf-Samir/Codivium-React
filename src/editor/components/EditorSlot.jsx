...
const EditorSlot = forwardRef(function EditorSlot(
  {
    ...
    onChange,
    className      = '',
    fontVarPrefix  = 'editor',  // 'editor' or 'repl' — selects which CSS vars to read
  },
  ref
) {
    ...
    >
      ...
      <textarea
        ...
        style={{
          ...
          color:       'inherit',
          fontFamily:  `var(--${fontVarPrefix}-font-family, ui-monospace, monospace)`,
          fontSize:    `var(--${fontVarPrefix}-font-size, 14px)`,
          fontWeight:  `var(--${fontVarPrefix}-font-weight, 400)`,
          lineHeight:  '1.6',
          padding:     '12px',
