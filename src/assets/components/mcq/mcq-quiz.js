  ...
  function initTimer() {
    ...
    function updateToggleIcon(hidden) {
      ...
      if (hidden) {
        ...
        p.setAttribute('strokeWidth', '2'); p.setAttribute('strokeLinecap', 'round');
        ...
        c.setAttribute('stroke','currentColor'); c.setAttribute('strokeWidth','2'); c.setAttribute('fill','none');
