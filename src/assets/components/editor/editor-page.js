...
(function () {
  ...
  if (ticksG) {
    for (var i = 0; i < 12; i++) {
      ...
      ln.setAttribute("strokeWidth", i % 3 === 0 ? "1.5" : "1");
      ln.setAttribute("strokeLinecap", "round");
  ...
  function updateToggleIcon(hidden) {
    ...
    if (hidden) {
      ...
      p1.setAttribute("strokeWidth", "2"); p1.setAttribute("strokeLinecap", "round");
      ...
      p2.setAttribute("strokeWidth", "2"); p2.setAttribute("strokeLinecap", "round");
      ...
      c.setAttribute("stroke", "currentColor"); c.setAttribute("strokeWidth", "2");
